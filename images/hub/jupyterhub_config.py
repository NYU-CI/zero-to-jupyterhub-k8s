...
c.JupyterHub.spawner_class = adrf.KubeSpawner
c.KubeSpawner.profile_form_template = adrf.PROFILE_FORM_TEMPLATE
c.KubeSpawner.profile_list = adrf.profile_list_function
